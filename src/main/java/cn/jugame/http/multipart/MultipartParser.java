...
package cn.jugame.http.multipart;
...
public class MultipartParser {
	...
	public MultipartParser(HttpRequest req) throws IOException {
		this(req, req.getContentLength(), true, true);
	}
	 ...
	 */
	public MultipartParser(HttpRequest req, int maxSize) throws IOException {
	 ...
	 *            stream.
	 */
	public MultipartParser(HttpRequest req, int maxSize, boolean buffer, boolean limitLength)
			throws IOException {
	 ...
	 */
	public MultipartParser(HttpRequest req, int maxSize, boolean buffer, boolean limitLength, String encoding)
			throws IOException {
